...
import MetricCard from './Child/MetricCard.jsx';
import {
    ...
    return (
        ...
        >
            {eComDashboardStatData.map((stat) => (
                ...
                >
                    <Text
                        className="mt-5 flex items-center border-t border-dashed border-muted pt-4 leading-none text-gray-500">
                        <Text
                            as="span"
                            className={cn(
