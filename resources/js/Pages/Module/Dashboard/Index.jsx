...
import HandWaveIcon from "./Component/Child/HandWaveIcon.jsx";
import StatCards from "./Component/StatCards.jsx";
import ProfitWidget from "./Component/ProfitWidget.jsx";
import SalesReport from "./Component/SalesReport.jsx";
import PromotionalSales from "./Component/PromotionalSales.jsx";
import RecentOrder from "./Component/RecentOrder.jsx";
import RepeatCustomerRate from "./Component/RepeatCustomerRate.jsx";
import BestSellers from "./Component/BestSellers.jsx";
import UserLocation from "./Component/UserLocation.jsx";
import StockReport from "./Component/StockReport.jsx";
                    ...
                    media={
                        <div className="absolute -bottom-6 end-4 hidden w-[300px] @2xl:block lg:w-[320px] 2xl:-bottom-7 2xl:w-[330px]">
                            <div className="relative">
                                <img
                                    src="/frontend/shop-illustration.png"
...
Index.layout = page => <MainLayout children={page} title="Welcome"/>
